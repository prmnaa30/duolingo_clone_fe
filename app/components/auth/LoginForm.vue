  ...
  >
    <UFormField name="email">
      <UInput
        ...
        class="w-full"
        :ui="{
          base: 'px-4 py-2 rounded-lg ring-2 ring-gray-300 ring-gray-300 dark:ring-gray-700 placeholder:text-text-grey placeholder:text-lg text-lg',
          trailing: 'pe-1'
        }"
      >
        <template
    ...
    <UFormField name="password">
      <UInput
        ...
        class="w-full"
        :ui="{
          base: 'px-4 py-2 rounded-lg ring-2 ring-gray-300 dark:ring-gray-700 placeholder:text-text-grey placeholder:text-lg text-lg',
          trailing: 'pe-1'
        }"
